import { LatLngBoundsExpression, ImageOverlay as LeafletImageOverlay, ImageOverlayOptions, SVGOverlay as LeafletSVGOverlay, VideoOverlay as LeafletVideoOverlay } from 'leaflet-rotate-map';
